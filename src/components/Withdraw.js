        ...
        <div className="container my-5 shadow rounded w-75">
          <div className="row">
            ...
            <form> 
              ...
              <input type="number" className='form-control p-2 mt-2' placeholder="Amount to Withdraw" required/>
              <input type="number" className='form-control p-2 mt-2'value={dash.acctno} required/>
              <input type="number" className='form-control p-2 mt-2' placeholder="Purpose of withdrawal" required/>
            
                <button className='btn text-white w-100 my-5'>Withdraw</button>
            </form>
          </div> 
          </div>
        </div>
