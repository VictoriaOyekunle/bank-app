      ...
      <div className="col-md-10 bg-light dashContent2 py-3">
        <div className="container my-5 shadow rounded">
          <div className="row">
            ...
            <p className='signinText text-center'>Transaction</p>
            <hr />
            <form> 
              ...
              <input type="email" className='form-control p-2 mt-2' placeholder={dash.email} required/>
              <input type="text" className='form-control p-2 mt-2' placeholder={dash.password} required/>
              <input type="number" className='form-control p-2 mt-2' placeholder={dash.phonenumber} required/>
